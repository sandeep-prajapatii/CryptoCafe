...
export default function Buy({state}) {
  ...
  const buyCoffee =  async (event) => {
    ...
    // let amount = document.getElementById("amountVal").value;
        ...
        <form  onSubmit={buyCoffee}>
          <div className='mb-4'>
            ...
            <input
              ...
              className='border-2 border-red-800 rounded w-2/4 h-10'
            />
          </div>
          <div className='mb-4'>
            ...
            <input
              ...
              className='border-2 border-red-800 rounded w-full h-10'
            />
          </div>
